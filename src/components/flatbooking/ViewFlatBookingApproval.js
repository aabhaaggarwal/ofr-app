            ...
            <div class="col-sm-6">
                    <div class="card-body bg-light">
                      ...
                      <p class="card-text">
                        ...
                        <div class="row">
                            <div class="col">
                            <button type="button" class="btn btn-success" value="approved"  onClick={(event) => setBStatus(event.target.value)}><i class="fa fa-check" aria-hidden="true"> Approve</i></button>
                            </div>
                            <div class="col">
                            <button type="button" class="btn btn-danger" value="rejected" onClick={(event) => setBStatus(event.target.value)}><i class="fa fa-times" aria-hidden="true"> Decline</i></button>
                            </div>
                        </div>
                      </p>
                    </div>
